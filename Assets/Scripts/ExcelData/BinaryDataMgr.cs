...
public class BinaryDataMgr
{
    ...
    {
        LoadTable<BagItemContainer, BagItem>();
        LoadTable<ShopItemContainer, ShopItem>();
    }
    ...
    public void LoadTable<T,K>()
    {
        ...
        using (FileStream fs = File.Open(DATA_BINARY_PATH + typeof(K).Name + ".myData", FileMode.Open, FileAccess.Read))
        {
    ...
    public void Save(object obj, string fileName)
    {
        ...
        using (FileStream fs = new FileStream(SAVE_PATH + fileName + ".myData", FileMode.OpenOrCreate, FileAccess.Write))
        {
    ...
    public T Load<T>(string fileName) where T:class
    {
        ...
        if( !File.Exists(SAVE_PATH + fileName + ".myData") )
            return default(T);

        T obj;
        using (FileStream fs = File.Open(SAVE_PATH + fileName + ".myData", FileMode.Open, FileAccess.Read))
        {
            BinaryFormatter bf = new BinaryFormatter();
